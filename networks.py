...
class SRGAN(object):
    def __init__(self, discriminator_model, generator_model, vgg_model,
        ...
        self.img_hr = Input(shape=self.hr_shape)                                # 64 ,64, 3
        self.img_lr = Input(shape=self.lr_shape)                                # 32, 32, 12
        self.fake_hr = self.G_model(self.img_lr)                                # 64, 64, 3
        self.fake_features = self.vgg_model(self.fake_hr)                       # 4, 4, 512
