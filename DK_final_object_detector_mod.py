            ...
            for _ in range(0, 5):
                if(output_dict['detection_scores'][_]> 0.995):
                    ...
                    while True:
                        ...
                        frame2, output_dict = detector2.detect_objects(frame2)
                        
                        for _ in range(0, 5):
        
							if(output_dict['detection_scores'][_]> 0.995):

						        extracted_img2 = Img_Extraction(output_dict['detection_boxes'][_], frameOrigin2, False)
								before = detecbox_queue[0]
							    standard = Img_Kld(extracted_img, before)
                                ...
                                numbering += 1 
                                #print(pathName)
                                cv2.imwrite(pathName, extracted_img2, [cv2.IMWRITE_PNG_COMPRESSION, 0])
